...
Harpy.harpify=function(e){return function(c){var h={},g;g={time:{blocked:0,dns:0,connect:0,send:0,wait:0,receive:0},type:{image:0,html:0,js:0,css:0,text:0,other:0},uncached:{image:0,html:0,js:0,css:0,text:0,other:0},size:{cache:0,download:0},requests:{cached:0,uncached:0},timing:{onContentLoad:0,onLoad:0,total:0}};var k=c.log.pages[0].pageTimings;g.timing.onLoad=k.onLoad;g.timing.total=k.onLoad;g.timing.onContentLoad=k.onContentLoad||k.onLoad;var a=new Date(c.log.pages[0].startedDateTime),d,f,l,m,
    n,p,q;for(d=0;d<c.log.entries.length;d++){f=c.log.entries[d];l=f.request.url;m=l.split("://")[1].split("/")[0];n=301===Number(f.response.status)||302===Number(f.response.status);q||n||(q=m);m=m===q?"identical":n||q&&-1!==m.indexOf(q.substr(q.indexOf(".")))?"internal":"external";f.harpy_info={};h[d]=f;f.harpy_info.source=m;0<d&&(l=l.replace(c.log.entries[0].request.url,""));m=e.util.getMimetype(f.response.content.mimeType);n=(new Date(f.startedDateTime)).getTime()+f.time;n>a.getTime()+k.total&&(g.timing.total=
    n-a);for(p in f.timings)f.timings.hasOwnProperty(p)&&0<f.timings[p]&&(g.time[p]+=f.timings[p]);g.type[m]+=f.response.bodySize;g.uncached[m]+=f.response.bodySize;g.size.download+=f.response.bodySize;f.harpy_info.index=d+1;f.harpy_info.url=l;f.harpy_info.mimetype=m;"(cache)"===f.response.status?(f.harpy_info.cache="cache",g.requests.cached+=1):(g.requests.uncached+=1,399<Number(f.response.status)&&(f.harpy_info.error="error"));f.cache.hasOwnProperty("afterRequest")?(g.size.cache+=f.response.content.size,
    g.type[m]+=f.response.content.size,f.harpy_info.size=f.response.content.size):f.harpy_info.size=f.response.bodySize;f.harpy_info.startTime=new Date(f.startedDateTime)-a}k={};k.time=g.timing;k.size=g.size;c.log.pages[0].harpy_info=k;return{har:c,stats:g,entryCache:h}}};
...
this.Harpy.Templates.data=Handlebars.template(function(e,c,h,g,k){this.compilerInfo=[4,">= 1.0.0"];h=this.merge(h,e.helpers);g=this.merge(g,e.partials);k=k||{};var a,d,f=this.escapeExpression,l=h.helperMissing,m=this;e=""+('<thead>\r\n    <tr>\r\n        <th></th>\r\n        <th>Method</th>\r\n        <th>URL</th>\r\n        <th>Status</th>\r\n        <th>Type</th>\r\n        <th>Size</th>\r\n        <th class="timeline">\r\n            <div class="loadMarker" data-dom="'+f((a=(a=(a=(a=(a=(a=c&&c.log,
        ...
        null==a||!1===a?a:a.entries),{hash:{},inverse:m.noop,fn:m.program(1,function(a,c){var d,b,e;d=""+('\r\n    <tr data-id="'+f((b=(b=c,null==b||!1===b?b:b.index),"function"===typeof b?b.apply(a):b))+'" class="'+f((b=(b=a&&a.harpy_info,null==b||!1===b?b:b.mimetype),"function"===typeof b?b.apply(a):b))+" "+f((b=(b=a&&a.harpy_info,null==b||!1===b?b:b.cache),"function"===typeof b?b.apply(a):b))+" "+f((b=(b=a&&a.harpy_info,null==b||!1===b?b:b.source),"function"===typeof b?b.apply(a):b))+" "+f((b=(b=a&&a.harpy_info,
        null==b||!1===b?b:b.error),"function"===typeof b?b.apply(a):b))+'">\r\n        <td>'+f((b=(b=a&&a.harpy_info,null==b||!1===b?b:b.index),"function"===typeof b?b.apply(a):b))+"</td>\r\n        <td>"+f((b=(b=a&&a.request,null==b||!1===b?b:b.method),"function"===typeof b?b.apply(a):b))+'</td>\r\n        <td class="url" title="'+f((b=(b=a&&a.harpy_info,null==b||!1===b?b:b.url),"function"===typeof b?b.apply(a):b))+'">');e={hash:{},data:c};d+=f((b=h.trimmer||a&&a.trimmer,b?b.call(a,(b=a&&a.harpy_info,null==
    b||!1===b?b:b.url),30,!0,e):l.call(a,"trimmer",(b=a&&a.harpy_info,null==b||!1===b?b:b.url),30,!0,e)))+'</td>\r\n        <td title="'+f((b=(b=a&&a.response,null==b||!1===b?b:b.status),"function"===typeof b?b.apply(a):b))+" "+f((b=(b=a&&a.response,null==b||!1===b?b:b.statusText),"function"===typeof b?b.apply(a):b))+'">'+f((b=(b=a&&a.response,null==b||!1===b?b:b.status),"function"===typeof b?b.apply(a):b))+'</td>\r\n        <td title="'+f((b=(b=(b=a&&a.response,null==b||!1===b?b:b.content),null==b||
    !1===b?b:b.mimeType),"function"===typeof b?b.apply(a):b))+'">'+f((b=(b=a&&a.harpy_info,null==b||!1===b?b:b.mimetype),"function"===typeof b?b.apply(a):b))+"</td>\r\n        <td>";e={hash:{},data:c};d+=f((b=h.format||a&&a.format,b?b.call(a,(b=a&&a.harpy_info,null==b||!1===b?b:b.size),"size",e):l.call(a,"format",(b=a&&a.harpy_info,null==b||!1===b?b:b.size),"size",e)))+'</td>\r\n        <td title="Blocked: '+f((b=(b=a&&a.timings,null==b||!1===b?b:b.blocked),"function"===typeof b?b.apply(a):b))+" ms, DNS: "+
    f((b=(b=a&&a.timings,null==b||!1===b?b:b.dns),"function"===typeof b?b.apply(a):b))+" ms, Connect: "+f((b=(b=a&&a.timings,null==b||!1===b?b:b.connect),"function"===typeof b?b.apply(a):b))+" ms, Send: "+f((b=(b=a&&a.timings,null==b||!1===b?b:b.send),"function"===typeof b?b.apply(a):b))+" ms, Wait: "+f((b=(b=a&&a.timings,null==b||!1===b?b:b.wait),"function"===typeof b?b.apply(a):b))+" ms, Receive: "+f((b=(b=a&&a.timings,null==b||!1===b?b:b.receive),"function"===typeof b?b.apply(a):b))+' ms">';if((b=
    m.invokePartial(g.timeline,"timeline",a,h,g,c))||0===b)d+=b;return d+"</td>\r\n    </tr>\r\n"},k),data:k}))||0===d)e+=d;e+='\r\n</tbody>\r\n<tfoot>\r\n    <tr class="total">\r\n        <td>'+f((a=(a=(a=c&&c.log,null==a||!1===a?a:a.entries),null==a||!1===a?a:a.length),"function"===typeof a?a.apply(c):a))+'</td>\r\n        <td colspan="4"></td>\r\n        <td>';d={hash:{},data:k};e+=f((a=h.format||c&&c.format,a?a.call(c,(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==
    a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.size),null==a||!1===a?a:a.download),"size",d):l.call(c,"format",(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.size),null==a||!1===a?a:a.download),"size",d)))+"</td>\r\n        <td>\r\n            (";d={hash:{},data:k};e+=f((a=h.format||c&&c.format,a?a.call(c,(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||
    !1===a?a:a.size),null==a||!1===a?a:a.cache),"size",d):l.call(c,"format",(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.size),null==a||!1===a?a:a.cache),"size",d)))+' from cache)\r\n            <span title="DOM: ';d={hash:{},data:k};e+=f((a=h.format||c&&c.format,a?a.call(c,(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.time),null==a||!1===a?
    a:a.onContentLoad),"time",d):l.call(c,"format",(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.time),null==a||!1===a?a:a.onContentLoad),"time",d)))+", Page: ";d={hash:{},data:k};e+=f((a=h.format||c&&c.format,a?a.call(c,(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.time),null==a||!1===a?a:a.onLoad),"time",d):l.call(c,"format",(a=(a=(a=(a=(a=
    c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.time),null==a||!1===a?a:a.onLoad),"time",d)))+'">';d={hash:{},data:k};return e+=f((a=h.format||c&&c.format,a?a.call(c,(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||!1===a?a:a.harpy_info),null==a||!1===a?a:a.time),null==a||!1===a?a:a.total),"time",d):l.call(c,"format",(a=(a=(a=(a=(a=c&&c.log,null==a||!1===a?a:a.pages),null==a||!1===a?a:a[0]),null==a||
    !1===a?a:a.harpy_info),null==a||!1===a?a:a.time),null==a||!1===a?a:a.total),"time",d)))+"</span>\r\n        </td>\r\n    </tr>\r\n</tfoot>"});
